...
-(id)init
{
    ...
    if (self) {
        ...
        self.equipmentModel = [[EquipmentModel alloc]init];
...
//        NSString *utf8Str = [CMMemberEntity.userInfo.unitsn stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
//        NSString *unicodeStr = [NSString stringWithCString:[utf8Str UTF8String] encoding:NSUnicodeStringEncoding];
        ...
        @weakify(self)
        [SocketIO_Singleton sendEmit:XS012 withMessage:jsonStr];
        SocketIO_Singleton.xr012CallBackResult = ^(NSDictionary *resultDict){
            @strongify(self)
            ...
            if ([errorcode isEqualToString:SUCCESS_CODE]) {
                ...
                [self.equipmentList addObjectsFromArray:(NSMutableArray *)[MTLJSONAdapter modelsOfClass:[EquipmentModel class] fromJSONArray:resultDict[@"datas"] error:nil]];
